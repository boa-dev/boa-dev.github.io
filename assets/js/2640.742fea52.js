"use strict";
(globalThis["webpackChunkboajs_dev"] = globalThis["webpackChunkboajs_dev"] || []).push([[2640],{
...
// src/diagrams/eventmodeling/db.ts
var setOptions = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(function(_rawOptString) {
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .R.debug("options str", _rawOptString);
}, "setOptions");
var getOptions = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(function() {
  return {};
}, "getOptions");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(reset, "reset");
var DEFAULT_EVENTMODELING_CONFIG = _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_2__/* .defaultConfig_default */ .UI.eventmodeling;
var getConfig3 = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(() => {
  const config = (0,_chunk_ICXQ74PX_mjs__WEBPACK_IMPORTED_MODULE_1__/* .cleanAndMerge */ .$t)({
    ...DEFAULT_EVENTMODELING_CONFIG,
    ...(0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getConfig */ .zj)().eventmodeling
  });
  return config;
}, "getConfig");
var store = {};
function getState() {
  ...
  ast.frames.forEach((frame, index) => {
    ...
    if (hasSourceFrame(frame)) {
      _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .R.debug(`source frame`, frame.sourceFrames);
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(getState, "getState");
function setAst(ast) {
  store.ast = ast;
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(setAst, "setAst");
var diagramProps = {
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(getDiagramProps, "getDiagramProps");
var initial = {
  boxes: [],
  swimlanes: {},
  relations: [],
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(extractNamespace, "extractNamespace");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(extractName, "extractName");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(findSwimlaneByNamespace, "findSwimlaneByNamespace");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(findNextAvailableIndex, "findNextAvailableIndex");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(calculateSwimlaneProps, "calculateSwimlaneProps");
function calculateEntityVisualProps(frame) {
  const { themeVariables } = (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getConfig */ .zj)();
  switch (frame.modelEntityType) {
    case "ui":
      return {
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(calculateEntityVisualProps, "calculateEntityVisualProps");
function calculateTextProps(frame, dataEntities, diagramProps2) {
  const config = (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getConfig */ .zj)();
  const name = (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_2__/* .sanitizeText */ .jZ)(extractName(frame.entityIdentifier) ?? "", config);
  let toHtml;
  ...
  const wrappedName = (0,_chunk_ICXQ74PX_mjs__WEBPACK_IMPORTED_MODULE_1__/* .wrapLabel */ .bH)(name, diagramProps2.textMaxWidth, wrapLabelConfig);
  ...
  if (frame.dataInlineValue) {
    ...
    toHtml = (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_2__/* .sanitizeText */ .jZ)(toHtml, config);
    toHtml = (0,_chunk_ICXQ74PX_mjs__WEBPACK_IMPORTED_MODULE_1__/* .wrapLabel */ .bH)(toHtml, diagramProps2.textMaxWidth, wrapLabelConfig);
  ...
  const dimensions = (0,_chunk_ICXQ74PX_mjs__WEBPACK_IMPORTED_MODULE_1__/* .calculateTextDimensions */ .PX)(content, textDimensionConfig);
  ...
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .R.debug(`[${frame.name}] ${frame.entityIdentifier} text`, props);
  return props;
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(calculateTextProps, "calculateTextProps");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(decidePositionFrame, "decidePositionFrame");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(calculateX, "calculateX");
function calculateMaxRight(swimlanes, swimlaneR) {
  const rs = [...swimlanes.map((s) => s.r), swimlaneR];
  return Math.max(...rs);
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(calculateMaxRight, "calculateMaxRight");
function sortedSwimlanesArray(swimlanes) {
  return Object.values(swimlanes).sort((a, b) => a.index - b.index);
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(sortedSwimlanesArray, "sortedSwimlanesArray");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(evolveFramePositioned, "evolveFramePositioned");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(isFirstFrame, "isFirstFrame");
function hasSourceFrame(frame) {
  return frame.sourceFrames !== void 0 && frame.sourceFrames !== null && frame.sourceFrames.length > 0;
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(hasSourceFrame, "hasSourceFrame");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(findBoxByFrame, "findBoxByFrame");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(findBoxByLineIndex, "findBoxByLineIndex");
function decidePositionRelation(state, _command) {
  const command = _command;
  if ((0,_mermaid_js_parser__WEBPACK_IMPORTED_MODULE_5__/* .isEmResetFrame */ .F5)(command.frame) || isFirstFrame(command.index, command.frame)) {
    return [];
  }
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(decidePositionRelation, "decidePositionRelation");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(evolveRelationPositioned, "evolveRelationPositioned");
var deciders = {
...
function decide(state, command) {
  ...
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .R.debug(`decided events`, events);
  return events;
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(decide, "decide");
function evolve(state, events) {
  ...
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .R.debug(`evolve events`, { state, newState, events });
  return newState;
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(evolve, "evolve");
function dispatch(state, command) {
  const events = decide(state, command);
  const newState = evolve(state, events);
  return newState;
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(dispatch, "dispatch");
var db = {
...
// src/diagrams/eventmodeling/parser.ts
var parser = {
  parse: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(async (input) => {
    const ast = await (0,_mermaid_js_parser__WEBPACK_IMPORTED_MODULE_5__/* .parse */ .qg)("eventmodeling", input);
    _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .R.debug(ast);
    db.setAst(ast);
...
var DEFAULT_CONFIG = (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getConfig2 */ .D7)();
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(renderD3Box, "renderD3Box");
function dirUpwards(sourceY, targetY) {
  return sourceY > targetY;
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(dirUpwards, "dirUpwards");
function renderD3Relation(diagram2, diagramProps2, arrowheadId, themeVariables) {
  return (relation) => {
    ...
    let sourceY;
    let targetY;
    _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .R.debug(`rendering relation up=${upwards} for `, {
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(renderD3Relation, "renderD3Relation");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(renderD3Swimlane, "renderD3Swimlane");
var draw = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(function(txt, id, ver, diagObj) {
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .R.debug("in eventmodeling renderer", txt + "\n", "id:", id, ver);
  if (!DEFAULT_EVENTMODELING_CONFIG2) {
    throw new Error("EventModeling config not found");
  }
  const db2 = diagObj.db;
  const { themeVariables, eventmodeling: config } = (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getConfig2 */ .D7)();
  ...
  (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_2__/* .setupGraphViewbox2 */ .mj)(void 0, diagram2, config?.padding ?? 30, config?.useMaxWidth);
}, "draw");
...
var getStyles = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)((_options) => ``, "getStyles");
