"use strict";
(globalThis["webpackChunkboajs_dev"] = globalThis["webpackChunkboajs_dev"] || []).push([[9725],{
...
/* harmony import */ var _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1293);
/* harmony import */ var _chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6827);
...
var parser = (function() {
  var o = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(function(k, v, o2, l) {
  ...
  var parser2 = {
    trace: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(function trace() {
    }, "trace"),
    yy: {},
    ...
    performAction: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
      var $0 = $$.length - 1;
      switch (yystate) {
        case 23:
          this.$ = $$[$0];
    ...
    parseError: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(function parseError(str, hash) {
      if (hash.recoverable) {
        this.trace(str);
      } else {
    ...
    parse: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(function parse(input) {
      ...
      (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(popStack, "popStack");
      function lex() {
        var token;
      ...
      (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(lex, "lex");
  ...
  var lexer = /* @__PURE__ */ (function() {
    var lexer2 = {
      ...
      setInput: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(function(input, yy) {
        this.yy = yy || this.yy || {};
        this._input = input;
      ...
      input: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(function() {
      ...
      unput: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(function(ch) {
        var len = ch.length;
        var lines = ch.split(/(?:\r\n?|\n)/g);
      ...
      more: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(function() {
        this._more = true;
        return this;
      }, "more"),
      // When called from action, signals the lexer that this rule fails to match the input, so the next matching rule (regex) should be tested instead.
      reject: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(function() {
      ...
      less: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(function(n) {
        this.unput(this.match.slice(n));
      }, "less"),
      // displays already matched input, i.e. for error messages
      pastInput: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(function() {
        var past = this.matched.substr(0, this.matched.length - this.match.length);
        return (past.length > 20 ? "..." : "") + past.substr(-20).replace(/\n/g, "");
      }, "pastInput"),
      // displays upcoming input, i.e. for error messages
      upcomingInput: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(function() {
        var next = this.match;
        if (next.length < 20) {
      ...
      showPosition: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(function() {
        var pre = this.pastInput();
        var c = new Array(pre.length + 1).join("-");
        return pre + this.upcomingInput() + "\n" + c + "^";
      }, "showPosition"),
      // test the lexed token: return FALSE when not a match, otherwise return token
      test_match: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(function(match, indexed_rule) {
      ...
      next: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(function() {
        if (this.done) {
          return this.EOF;
        }
        if (!this._input) {
      ...
      lex: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(function lex() {
        var r = this.next();
        if (r) {
          return r;
        } else {
      ...
      begin: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(function begin(condition) {
        this.conditionStack.push(condition);
      }, "begin"),
      // pop the previously active lexer condition state off the condition stack
      popState: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(function popState() {
      ...
      _currentRules: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(function _currentRules() {
      ...
      topState: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(function topState(n) {
      ...
      pushState: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(function pushState(condition) {
        this.begin(condition);
      }, "pushState"),
      // return the number of states currently on the stack
      stateStackSize: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(function stateStackSize() {
        return this.conditionStack.length;
      }, "stateStackSize"),
      options: { "case-insensitive": true },
      performAction: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(function anonymous(yy, yy_, $avoiding_name_collisions, YY_START) {
  ...
  (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(Parser, "Parser");
...
var defaultThemeVariables = (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getThemeVariables */ .P$)();
var QuadrantBuilder = class {
  ...
  static {
    (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(this, "QuadrantBuilder");
  }
  getDefaultData() {
    return {
      titleText: "",
  ...
  getDefaultConfig() {
    return {
      ...
      showYAxis: true,
      showTitle: true,
      chartHeight: _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.chartWidth || 500,
      chartWidth: _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.chartHeight || 500,
      titlePadding: _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.titlePadding || 10,
      titleFontSize: _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.titleFontSize || 20,
      quadrantPadding: _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.quadrantPadding || 5,
      xAxisLabelPadding: _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.xAxisLabelPadding || 5,
      yAxisLabelPadding: _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.yAxisLabelPadding || 5,
      xAxisLabelFontSize: _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.xAxisLabelFontSize || 16,
      yAxisLabelFontSize: _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.yAxisLabelFontSize || 16,
      quadrantLabelFontSize: _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.quadrantLabelFontSize || 16,
      quadrantTextTopPadding: _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.quadrantTextTopPadding || 5,
      pointTextPadding: _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.pointTextPadding || 5,
      pointLabelFontSize: _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.pointLabelFontSize || 12,
      pointRadius: _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.pointRadius || 5,
      xAxisPosition: _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.xAxisPosition || "top",
      yAxisPosition: _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.yAxisPosition || "left",
      quadrantInternalBorderStrokeWidth: _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.quadrantInternalBorderStrokeWidth || 1,
      quadrantExternalBorderStrokeWidth: _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.quadrantExternalBorderStrokeWidth || 2
    };
  }
  ...
  clear() {
    ...
    this.data = this.getDefaultData();
    this.classes = /* @__PURE__ */ new Map();
    _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_1__/* .log */ .R.info("clear called");
  }
  setData(data) {
  ...
  setConfig(config) {
    _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_1__/* .log */ .R.trace("setConfig called with: ", config);
    this.config = { ...this.config, ...config };
  }
  setThemeConfig(themeConfig) {
    _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_1__/* .log */ .R.trace("setThemeConfig called with: ", themeConfig);
  ...
  getQuadrantPoints(spaceData) {
    ...
    const xAxis = (0,d3__WEBPACK_IMPORTED_MODULE_3__/* .scaleLinear */ .m4Y)().domain([0, 1]).range([quadrantLeft, quadrantWidth + quadrantLeft]);
    const yAxis = (0,d3__WEBPACK_IMPORTED_MODULE_3__/* .scaleLinear */ .m4Y)().domain([0, 1]).range([quadrantHeight + quadrantTop, quadrantTop]);
...
var InvalidStyleError = class extends Error {
  static {
    (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(this, "InvalidStyleError");
  }
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(validateHexCode, "validateHexCode");
function validateNumber(value) {
  return !/^\d+$/.test(value);
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(validateNumber, "validateNumber");
function validateSizeInPixels(value) {
  return !/^\d+px$/.test(value);
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(validateSizeInPixels, "validateSizeInPixels");

// src/diagrams/quadrant-chart/quadrantDb.ts
function textSanitizer(text) {
  return (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .sanitizeText */ .jZ)(text.trim(), (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getConfig2 */ .D7)());
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(textSanitizer, "textSanitizer");
var quadrantBuilder = new QuadrantBuilder();
function setQuadrant1Text(textObj) {
  quadrantBuilder.setData({ quadrant1Text: textSanitizer(textObj.text) });
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(setQuadrant1Text, "setQuadrant1Text");
function setQuadrant2Text(textObj) {
  quadrantBuilder.setData({ quadrant2Text: textSanitizer(textObj.text) });
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(setQuadrant2Text, "setQuadrant2Text");
function setQuadrant3Text(textObj) {
  quadrantBuilder.setData({ quadrant3Text: textSanitizer(textObj.text) });
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(setQuadrant3Text, "setQuadrant3Text");
function setQuadrant4Text(textObj) {
  quadrantBuilder.setData({ quadrant4Text: textSanitizer(textObj.text) });
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(setQuadrant4Text, "setQuadrant4Text");
function setXAxisLeftText(textObj) {
  quadrantBuilder.setData({ xAxisLeftText: textSanitizer(textObj.text) });
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(setXAxisLeftText, "setXAxisLeftText");
function setXAxisRightText(textObj) {
  quadrantBuilder.setData({ xAxisRightText: textSanitizer(textObj.text) });
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(setXAxisRightText, "setXAxisRightText");
function setYAxisTopText(textObj) {
  quadrantBuilder.setData({ yAxisTopText: textSanitizer(textObj.text) });
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(setYAxisTopText, "setYAxisTopText");
function setYAxisBottomText(textObj) {
  quadrantBuilder.setData({ yAxisBottomText: textSanitizer(textObj.text) });
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(setYAxisBottomText, "setYAxisBottomText");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(parseStyles, "parseStyles");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(addPoint, "addPoint");
function addClass(className, styles) {
  quadrantBuilder.addClass(className, parseStyles(styles));
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(addClass, "addClass");
function setWidth(width) {
  quadrantBuilder.setConfig({ chartWidth: width });
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(setWidth, "setWidth");
function setHeight(height) {
  quadrantBuilder.setConfig({ chartHeight: height });
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(setHeight, "setHeight");
function getQuadrantData() {
  const config = (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getConfig2 */ .D7)();
  ...
  quadrantBuilder.setData({ titleText: (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getDiagramTitle */ .ab)() });
  return quadrantBuilder.build();
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(getQuadrantData, "getQuadrantData");
var clear2 = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(function() {
  quadrantBuilder.clear();
  (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .clear */ .IU)();
}, "clear");
var quadrantDb_default = {
  ...
  getQuadrantData,
  clear: clear2,
  setAccTitle: _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .setAccTitle */ .SV,
  getAccTitle: _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getAccTitle */ .iN,
  setDiagramTitle: _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .setDiagramTitle */ .ke,
  getDiagramTitle: _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getDiagramTitle */ .ab,
  getAccDescription: _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getAccDescription */ .m7,
  setAccDescription: _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .setAccDescription */ .EI
};

// src/diagrams/quadrant-chart/quadrantRenderer.ts

var draw = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)((txt, id, _version, diagObj) => {
  function getDominantBaseLine(horizontalPos) {
    return horizontalPos === "top" ? "hanging" : "middle";
  }
  (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(getDominantBaseLine, "getDominantBaseLine");
  function getTextAnchor(verticalPos) {
    return verticalPos === "left" ? "start" : "middle";
  }
  (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(getTextAnchor, "getTextAnchor");
  function getTransformation(data) {
    return `translate(${data.x}, ${data.y}) rotate(${data.rotation || 0})`;
  }
  (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(getTransformation, "getTransformation");
  const conf = (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getConfig2 */ .D7)();
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_1__/* .log */ .R.debug("Rendering quadrant chart\n" + txt);
  ...
  (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .configureSvgSize */ .a$)(svg, height, width, conf.quadrantChart?.useMaxWidth ?? true);
...
var diagram = {
  ...
  styles: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)(() => "", "styles")
};
