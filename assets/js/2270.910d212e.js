"use strict";
(self["webpackChunkboajs_dev"] = self["webpackChunkboajs_dev"] || []).push([[2270],{
...
const DEFAULT_PIE_CONFIG = _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_4__.B.pie;
...
const addSection = (label, value) => {
  label = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_4__.d)(label, (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_4__.c)());
  if (sections[label] === void 0) {
    sections[label] = value;
    _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(`added new section: ${label}, with value: ${value}`);
  }
};
...
const draw = (text, id, _version, diagObj) => {
  _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("rendering pie chart\n" + text);
  const db2 = diagObj.db;
  const globalConfig = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_4__.c)();
  const pieConfig = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_4__.C)(db2.getConfig(), globalConfig.pie);
  const MARGIN = 40;
  ...
  let [outerStrokeWidth] = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_4__.D)(themeVariables.pieOuterStrokeWidth);
  ...
  (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_4__.i)(svg, height, totalWidth, pieConfig.useMaxWidth);
};
const renderer = { draw };
const diagram = {
  parser: parser$1,
