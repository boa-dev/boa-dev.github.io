...
function BoaPlayground(){const[input,setInput]=react.useState(initialCode);const[evaluate,setEvaluate]=react.useState(null);react.useEffect(()=>{__webpack_require__.e(/* import() */ 18).then(__webpack_require__.bind(__webpack_require__, 18)).then(_ref=>{let{evaluate}=_ref;return setEvaluate(()=>evaluate);});},[]);const output=react.useMemo(()=>{if(evaluate!==null){try{return evaluate(input);}catch(e){return e;}}},[input,evaluate]);return/*#__PURE__*/(0,jsx_runtime.jsx)(Layout/* default */.A,{title:"Playground",description:"Boa Playground",children:/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:index_module.playgroundLayout,children:[/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:index_module.playgroundEditor,children:/*#__PURE__*/(0,jsx_runtime.jsx)(dist/* default */.Ay,{theme:"vs-dark",language:"javascript",options:{minimap:{enabled:false}},value:input,onChange:setInput})}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:index_module.playgroundOutput,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Heading/* default */.A,{as:"h1",children:"Output"}),`> ${output??""}`]})]})});}
