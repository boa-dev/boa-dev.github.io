"use strict";
(self["webpackChunkboajs_dev"] = self["webpackChunkboajs_dev"] || []).push([[4632],{
...
var defaultThemeVariables = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getThemeVariables */ .P$)();
var QuadrantBuilder = class {
  ...
  static {
    (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(this, "QuadrantBuilder");
  }
  getDefaultData() {
    return {
      titleText: "",
  ...
  getDefaultConfig() {
    return {
      ...
      showYAxis: true,
      showTitle: true,
      chartHeight: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.chartWidth || 500,
      chartWidth: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.chartHeight || 500,
      titlePadding: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.titlePadding || 10,
      titleFontSize: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.titleFontSize || 20,
      quadrantPadding: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.quadrantPadding || 5,
      xAxisLabelPadding: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.xAxisLabelPadding || 5,
      yAxisLabelPadding: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.yAxisLabelPadding || 5,
      xAxisLabelFontSize: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.xAxisLabelFontSize || 16,
      yAxisLabelFontSize: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.yAxisLabelFontSize || 16,
      quadrantLabelFontSize: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.quadrantLabelFontSize || 16,
      quadrantTextTopPadding: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.quadrantTextTopPadding || 5,
      pointTextPadding: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.pointTextPadding || 5,
      pointLabelFontSize: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.pointLabelFontSize || 12,
      pointRadius: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.pointRadius || 5,
      xAxisPosition: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.xAxisPosition || "top",
      yAxisPosition: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.yAxisPosition || "left",
      quadrantInternalBorderStrokeWidth: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.quadrantInternalBorderStrokeWidth || 1,
      quadrantExternalBorderStrokeWidth: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConfig_default */ .UI.quadrantChart?.quadrantExternalBorderStrokeWidth || 2
    };
  }
  ...
  clear() {
    ...
    this.data = this.getDefaultData();
    this.classes = /* @__PURE__ */ new Map();
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .Rm.info("clear called");
  }
  setData(data) {
  ...
  setConfig(config2) {
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .Rm.trace("setConfig called with: ", config2);
    this.config = { ...this.config, ...config2 };
  }
  setThemeConfig(themeConfig) {
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .Rm.trace("setThemeConfig called with: ", themeConfig);
...
var InvalidStyleError = class extends Error {
  static {
    (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(this, "InvalidStyleError");
  }
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(validateHexCode, "validateHexCode");
function validateNumber(value) {
  return !/^\d+$/.test(value);
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(validateNumber, "validateNumber");
function validateSizeInPixels(value) {
  return !/^\d+px$/.test(value);
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(validateSizeInPixels, "validateSizeInPixels");

// src/diagrams/quadrant-chart/quadrantDb.ts
var config = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getConfig2 */ .D7)();
function textSanitizer(text) {
  return (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .sanitizeText */ .jZ)(text.trim(), config);
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(textSanitizer, "textSanitizer");
var quadrantBuilder = new QuadrantBuilder();
function setQuadrant1Text(textObj) {
  quadrantBuilder.setData({ quadrant1Text: textSanitizer(textObj.text) });
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(setQuadrant1Text, "setQuadrant1Text");
function setQuadrant2Text(textObj) {
  quadrantBuilder.setData({ quadrant2Text: textSanitizer(textObj.text) });
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(setQuadrant2Text, "setQuadrant2Text");
function setQuadrant3Text(textObj) {
  quadrantBuilder.setData({ quadrant3Text: textSanitizer(textObj.text) });
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(setQuadrant3Text, "setQuadrant3Text");
function setQuadrant4Text(textObj) {
  quadrantBuilder.setData({ quadrant4Text: textSanitizer(textObj.text) });
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(setQuadrant4Text, "setQuadrant4Text");
function setXAxisLeftText(textObj) {
  quadrantBuilder.setData({ xAxisLeftText: textSanitizer(textObj.text) });
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(setXAxisLeftText, "setXAxisLeftText");
function setXAxisRightText(textObj) {
  quadrantBuilder.setData({ xAxisRightText: textSanitizer(textObj.text) });
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(setXAxisRightText, "setXAxisRightText");
function setYAxisTopText(textObj) {
  quadrantBuilder.setData({ yAxisTopText: textSanitizer(textObj.text) });
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(setYAxisTopText, "setYAxisTopText");
function setYAxisBottomText(textObj) {
  quadrantBuilder.setData({ yAxisBottomText: textSanitizer(textObj.text) });
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(setYAxisBottomText, "setYAxisBottomText");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(parseStyles, "parseStyles");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(addPoint, "addPoint");
function addClass(className, styles) {
  quadrantBuilder.addClass(className, parseStyles(styles));
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(addClass, "addClass");
function setWidth(width) {
  quadrantBuilder.setConfig({ chartWidth: width });
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(setWidth, "setWidth");
function setHeight(height) {
  quadrantBuilder.setConfig({ chartHeight: height });
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(setHeight, "setHeight");
function getQuadrantData() {
  const config2 = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getConfig2 */ .D7)();
  ...
  quadrantBuilder.setData({ titleText: (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getDiagramTitle */ .ab)() });
  return quadrantBuilder.build();
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(getQuadrantData, "getQuadrantData");
var clear2 = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function() {
...
var quadrantDb_default = {
  ...
  setDiagramTitle: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .setDiagramTitle */ .ke,
  getDiagramTitle: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getDiagramTitle */ .ab,
...
var draw = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((txt, id, _version, diagObj) => {
  function getDominantBaseLine(horizontalPos) {
    return horizontalPos === "top" ? "hanging" : "middle";
  }
  (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(getDominantBaseLine, "getDominantBaseLine");
  function getTextAnchor(verticalPos) {
    return verticalPos === "left" ? "start" : "middle";
  }
  (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(getTextAnchor, "getTextAnchor");
  function getTransformation(data) {
    return `translate(${data.x}, ${data.y}) rotate(${data.rotation || 0})`;
  }
  (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(getTransformation, "getTransformation");
  const conf = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getConfig2 */ .D7)();
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .Rm.debug("Rendering quadrant chart\n" + txt);
  ...
  (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .configureSvgSize */ .a$)(svg, height, width, conf.quadrantChart?.useMaxWidth ?? true);
...
var diagram = {
  ...
  styles: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(() => "", "styles")
};
