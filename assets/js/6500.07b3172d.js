"use strict";
(globalThis["webpackChunkboajs_dev"] = globalThis["webpackChunkboajs_dev"] || []).push([[6500],{
...
// EXTERNAL MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-HHEYEP7N.mjs
var chunk_HHEYEP7N = __webpack_require__(1475);
...
var adjust_channel = __webpack_require__(5635);
...
var rough_esm = __webpack_require__(9893);
...
var addSubsetData = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)((identifierList, label, size) => {
...
var getSubsetData = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)(() => {
  return subsets;
}, "getSubsetData");
var normalizeText = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)((text) => {
...
var normalizeStyleValue = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)((value) => {
  return value ? normalizeText(value) : value;
}, "normalizeStyleValue");
var addTextData = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)((identifierList, id, label) => {
...
var addStyleData = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)((identifierList, data) => {
...
var getStyleData = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)(() => {
  return styleEntries;
}, "getStyleData");
var normalizeIdentifierList = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)((identifierList) => {
  return identifierList.map((identifier) => normalizeText(identifier));
}, "normalizeIdentifierList");
var validateUnionIdentifiers = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)((identifierList) => {
...
var getTextData = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)(() => {
  return textNodes;
}, "getTextData");
var getCurrentSets = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)(() => currentSets, "getCurrentSets");
var getIndentMode = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)(() => indentMode, "getIndentMode");
var setIndentMode = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)((enabled) => {
  indentMode = enabled;
}, "setIndentMode");
var DEFAULT_VENN_CONFIG = chunk_7R4GIKGN/* defaultConfig_default */.UI.venn;
function getConfig2() {
  return (0,chunk_GEFDOKGD/* cleanAndMerge */.$t)(DEFAULT_VENN_CONFIG, (0,chunk_7R4GIKGN/* getConfig */.zj)().venn);
}
(0,chunk_AGHRB4JF/* __name */.K2)(getConfig2, "getConfig");
var customClear = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)(() => {
  (0,chunk_7R4GIKGN/* clear */.IU)();
  subsets.length = 0;
  textNodes.length = 0;
...
var db = {
  ...
  clear: customClear,
  setAccTitle: chunk_7R4GIKGN/* setAccTitle */.SV,
  getAccTitle: chunk_7R4GIKGN/* getAccTitle */.iN,
  setDiagramTitle: chunk_7R4GIKGN/* setDiagramTitle */.ke,
  getDiagramTitle: chunk_7R4GIKGN/* getDiagramTitle */.ab,
  getAccDescription: chunk_7R4GIKGN/* getAccDescription */.m7,
  setAccDescription: chunk_7R4GIKGN/* setAccDescription */.EI,
  addSubsetData,
  getSubsetData,
  addTextData,
  addStyleData,
...
(0,chunk_AGHRB4JF/* __name */.K2)(buildStyleByKey, "buildStyleByKey");
var draw = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)((_text, id, _version, diagObj) => {
  const db2 = diagObj.db;
  const config = db2.getConfig?.();
  const { themeVariables, look, handDrawnSeed } = (0,chunk_7R4GIKGN/* getConfig */.zj)();
  ...
  const svg = (0,chunk_HHEYEP7N/* selectSvgElement */.D)(id);
  ...
  (0,chunk_7R4GIKGN/* configureSvgSize */.a$)(svg, svgHeight, svgWidth, config?.useMaxWidth ?? true);
}, "draw");
function stableSetsKey(setIds) {
  return setIds.join("|");
}
(0,chunk_AGHRB4JF/* __name */.K2)(stableSetsKey, "stableSetsKey");
...
(0,chunk_AGHRB4JF/* __name */.K2)(renderTextNodes, "renderTextNodes");
var renderer = { draw };
