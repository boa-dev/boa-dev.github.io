"use strict";
(self["webpackChunkboajs_dev"] = self["webpackChunkboajs_dev"] || []).push([[899],{
...
// EXTERNAL MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-3AY6CYHV.mjs
var chunk_3AY6CYHV = __webpack_require__(6834);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-7GE3RBXV.mjs
var chunk_7GE3RBXV = __webpack_require__(6737);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-CXMOBAN2.mjs
var chunk_CXMOBAN2 = __webpack_require__(299);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-CVBHYZKI.mjs
var chunk_CVBHYZKI = __webpack_require__(3245);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-QYVHNE3D.mjs
var chunk_QYVHNE3D = __webpack_require__(7571);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-JA3XYJ7Z.mjs + 13 modules
var chunk_JA3XYJ7Z = __webpack_require__(92);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-S3R3BYOJ.mjs
var chunk_S3R3BYOJ = __webpack_require__(3226);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-ABZYJK2D.mjs + 3 modules
var chunk_ABZYJK2D = __webpack_require__(7633);
...
;// ./node_modules/mermaid/dist/chunks/mermaid.core/dagre-5GWH7T2D.mjs
...
var recursiveRender = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)(async (_elem, graph, diagramType, id, parentCluster, siteConfig) => {
  ...
  await Promise.all(
    graph.nodes().map(async function(v) {
      ...
      if (node?.clusterNode) {
        ...
        const newEl = o.elem;
        (0,chunk_CXMOBAN2/* updateNodeBounds */.lC)(node, newEl);
        node.diff = o.diff || 0;
        chunk_AGHRB4JF/* log */.Rm.info(
        ...
        (0,chunk_CXMOBAN2/* setNodeElem */.U7)(newEl, node);
      } else {
        if (graph.children(v).length > 0) {
          ...
          await (0,chunk_CXMOBAN2/* insertNode */.on)(nodes, graph.node(v), { config: siteConfig, dir });
        }
      }
    })
  );
  const processEdges = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)(async () => {
    const edgePromises = graph.edges().map(async function(e) {
      ...
      await (0,chunk_3AY6CYHV/* insertEdgeLabel */.jP)(edgeLabels, edge);
    });
  ...
  await Promise.all(
    sortNodesByHierarchy(graph).map(async function(v) {
      ...
      if (node?.clusterNode) {
        ...
        (0,chunk_CXMOBAN2/* positionNode */.U_)(node);
      } else {
        if (graph.children(v).length > 0) {
          chunk_AGHRB4JF/* log */.Rm.info(
          ...
          await (0,chunk_CXMOBAN2/* insertCluster */.U)(clusters, node);
          clusterDb.get(node.id).node = node;
        } else {
  ...
  graph.edges().forEach(function(e) {
    ...
    const paths = (0,chunk_3AY6CYHV/* insertEdge */.Jo)(edgePaths, edge, clusterDb, diagramType, startNode, endNode, id);
    (0,chunk_3AY6CYHV/* positionEdgeLabel */.T_)(edge, paths);
  });
...
var render = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)(async (data4Layout, svg) => {
  ...
  (0,chunk_3AY6CYHV/* markers_default */.g0)(element, data4Layout.markers, data4Layout.type, data4Layout.diagramId);
  (0,chunk_CXMOBAN2/* clear2 */.gh)();
  (0,chunk_3AY6CYHV/* clear */.IU)();
  (0,chunk_CXMOBAN2/* clear */.IU)();
  clear4();
