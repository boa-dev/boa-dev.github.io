"use strict";
(globalThis["webpackChunkboajs_dev"] = globalThis["webpackChunkboajs_dev"] || []).push([[5895],{
...
var RequirementDB = class {
  constructor() {
    ...
    this.getConfig = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .__name */ .K2)(() => (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig2 */ .D7)().requirement, "getConfig");
    this.clear();
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .__name */ .K2)(async function(text, id, _version, diag) {
  ...
  const { securityLevel, state: conf, layout } = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig2 */ .D7)();
  ...
  (0,_chunk_KX2RTZJC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .setupViewPortForSVG */ .P)(svg, padding, "requirementDiagram", conf?.useMaxWidth ?? true);
}, "draw");
