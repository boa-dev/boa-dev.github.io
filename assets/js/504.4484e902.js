"use strict";
(globalThis["webpackChunkboajs_dev"] = globalThis["webpackChunkboajs_dev"] || []).push([[504],{
...
var dagre = __webpack_require__(9051);
...
var recursiveRender = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)(async (_elem, graph, diagramType, id, parentCluster, siteConfig) => {
  ...
  await Promise.all(
    graph.nodes().map(async function(v) {
      ...
      if (node?.clusterNode) {
        ...
        const newEl = o.elem;
        (0,chunk_KYZI473N/* updateNodeBounds */.lC)(node, newEl);
        node.diff = o.diff || 0;
        chunk_AGHRB4JF/* log */.Rm.info(
        ...
        (0,chunk_KYZI473N/* setNodeElem */.U7)(newEl, node);
      } else {
        if (graph.children(v).length > 0) {
          ...
          await (0,chunk_KYZI473N/* insertNode */.on)(nodes, graph.node(v), { config: siteConfig, dir });
        }
      }
    })
  );
  const processEdges = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)(async () => {
    const edgePromises = graph.edges().map(async function(e) {
      ...
      await (0,chunk_O4XLMI2P/* insertEdgeLabel */.jP)(edgeLabels, edge);
    });
  ...
  let diff = 0;
  let { subGraphTitleTotalMargin } = (0,chunk_YBOYWFTD/* getSubGraphTitleMargins */.O)(siteConfig);
  await Promise.all(
    sortNodesByHierarchy(graph).map(async function(v) {
      ...
      if (node?.clusterNode) {
        ...
        (0,chunk_KYZI473N/* positionNode */.U_)(node);
      } else {
        if (graph.children(v).length > 0) {
          chunk_AGHRB4JF/* log */.Rm.info(
          ...
          await (0,chunk_KYZI473N/* insertCluster */.U)(clusters, node);
          clusterDb.get(node.id).node = node;
        } else {
  ...
  graph.edges().forEach(function(e) {
    ...
    const paths = (0,chunk_O4XLMI2P/* insertEdge */.Jo)(edgePaths, edge, clusterDb, diagramType, startNode, endNode, id);
    (0,chunk_O4XLMI2P/* positionEdgeLabel */.T_)(edge, paths);
  });
...
var render = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)(async (data4Layout, svg) => {
  ...
  (0,chunk_O4XLMI2P/* markers_default */.g0)(element, data4Layout.markers, data4Layout.type, data4Layout.diagramId);
  (0,chunk_KYZI473N/* clear2 */.gh)();
  (0,chunk_O4XLMI2P/* clear */.IU)();
  (0,chunk_KYZI473N/* clear */.IU)();
  clear4();
  ...
  const siteConfig = (0,chunk_7R4GIKGN/* getConfig2 */.D7)();
