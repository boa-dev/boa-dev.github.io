(globalThis["webpackChunkboajs_dev"] = globalThis["webpackChunkboajs_dev"] || []).push([[2180],{
...
/* harmony import */ var cytoscape__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(165);
/* harmony import */ var cytoscape_cose_bilkent__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3457);
...
cytoscape__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A.use(cytoscape_cose_bilkent__WEBPACK_IMPORTED_MODULE_3__);
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K)(addNodes, "addNodes");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K)(addEdges, "addEdges");
function createCytoscapeInstance(data) {
  return new Promise((resolve) => {
    const renderEl = (0,d3__WEBPACK_IMPORTED_MODULE_4__/* .select */ .Ltv)("body").append("div").attr("id", "cy").attr("style", "display:none");
    const cy = (0,cytoscape__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)({
    ...
    cy.ready((e) => {
      _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .R.info("Cytoscape ready", e);
      resolve(cy);
    });
  });
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K)(createCytoscapeInstance, "createCytoscapeInstance");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K)(extractPositionedNodes, "extractPositionedNodes");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K)(extractPositionedEdges, "extractPositionedEdges");

// src/rendering-util/layout-algorithms/cose-bilkent/layout.ts
async function executeCoseBilkentLayout(data, _config) {
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .R.debug("Starting cose-bilkent layout algorithm");
  try {
    ...
    _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .R.debug(`Layout completed: ${positionedNodes.length} nodes, ${positionedEdges.length} edges`);
    return {
      nodes: positionedNodes,
      edges: positionedEdges
    };
  } catch (error) {
    _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .R.error("Error in cose-bilkent layout algorithm:", error);
    throw error;
  }
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K)(executeCoseBilkentLayout, "executeCoseBilkentLayout");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K)(validateLayoutData, "validateLayoutData");

// src/rendering-util/layout-algorithms/cose-bilkent/render.ts
var render = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K)(async (data4Layout, svg, {
  insertCluster,
  insertEdge,
  insertEdgeLabel,
  insertMarkers,
