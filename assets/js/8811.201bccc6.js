"use strict";
(globalThis["webpackChunkboajs_dev"] = globalThis["webpackChunkboajs_dev"] || []).push([[8811],{
...
/* harmony import */ var _chunk_PQ6SQG4A_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1960);
/* harmony import */ var _chunk_4BX2VUAB_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5871);
...
var TreeMapDB = class {
  constructor() {
    ...
    this.setAccTitle = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__/* .setAccTitle */ .SV;
    this.getAccTitle = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getAccTitle */ .iN;
    this.setDiagramTitle = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__/* .setDiagramTitle */ .ke;
    this.getDiagramTitle = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getDiagramTitle */ .ab;
    this.getAccDescription = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getAccDescription */ .m7;
    this.setAccDescription = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__/* .setAccDescription */ .EI;
  }
  static {
  ...
  getConfig() {
    const defaultConfig = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__/* .defaultConfig_default */ .UI;
    const userConfig = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig */ .zj)();
    return (0,_chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_4__/* .cleanAndMerge */ .$t)({
  ...
  addClass(id, _style) {
    ...
    if (styles) {
      styles.forEach((s) => {
        if ((0,_chunk_PQ6SQG4A_mjs__WEBPACK_IMPORTED_MODULE_2__/* .isLabelStyle */ .KX)(s)) {
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((_text, id, _version, diagram2) => {
  ...
  const { themeVariables } = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig */ .zj)();
  if (!root) {
    return;
  }
  ...
  (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_5__/* .configureSvgSize */ .a$)(svg, svgHeight, svgWidth, config.useMaxWidth);
  let valueFormat;
  try {
  ...
  sections.append("rect").attr("width", (d) => d.x1 - d.x0).attr("height", (d) => d.y1 - d.y0).attr("class", (_d, i) => {
    ...
    const styles = (0,_chunk_PQ6SQG4A_mjs__WEBPACK_IMPORTED_MODULE_2__/* .styles2String */ .GX)({ cssCompiledStyles: d.data.cssCompiledStyles });
  ...
  (0,_chunk_KX2RTZJC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .setupViewPortForSVG */ .P)(svg, diagramPadding, "flowchart", config?.useMaxWidth || false);
}, "draw");
...
var getStyles = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(({
  ...
  const options = (0,_chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_4__/* .cleanAndMerge */ .$t)(defaultTreemapStyleOptions, treemap2);
  return `
  .treemapNode.section {
