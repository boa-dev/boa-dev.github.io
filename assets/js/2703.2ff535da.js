"use strict";
(globalThis["webpackChunkboajs_dev"] = globalThis["webpackChunkboajs_dev"] || []).push([[2703],{
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AC: () => (/* binding */ diagram),
/* harmony export */   tM: () => (/* binding */ styles_default),
/* harmony export */   ur: () => (/* binding */ createFlowDiagram)
/* harmony export */ });
/* harmony import */ var _chunk_5VM5RSS4_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4918);
...
/* harmony import */ var _chunk_ZIRB5QZD_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1818);
/* harmony import */ var _chunk_FWX5IMBZ_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6923);
/* harmony import */ var _chunk_32BRIVSS_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(2389);
/* harmony import */ var _chunk_ZGVPDNZ5_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(5999);
/* harmony import */ var _chunk_ICXQ74PX_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(830);
/* harmony import */ var _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(7391);
/* harmony import */ var _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(1293);
/* harmony import */ var _chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(6827);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(451);
/* harmony import */ var dompurify__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(9418);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(5582);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(5937);
...
var FlowDB = class {
  ...
  constructor() {
    ...
    this.config = (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)();
    this.diagramId = "";
    ...
    this.funs = [];
    this.setAccTitle = _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_8__/* .setAccTitle */ .SV;
    this.setAccDescription = _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_8__/* .setAccDescription */ .EI;
    this.setDiagramTitle = _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_8__/* .setDiagramTitle */ .ke;
    this.getAccTitle = _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getAccTitle */ .iN;
    this.getAccDescription = _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getAccDescription */ .m7;
    this.getDiagramTitle = _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getDiagramTitle */ .ab;
  ...
  static {
    (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(this, "FlowDB");
  }
  sanitizeText(txt) {
    return _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_8__/* .common_default */ .Y2.sanitizeText(txt, this.config);
  }
  ...
  addVertex(id, textObj, type, style, classes, dir, props = {}, metadata) {
    ...
    if (metadata !== void 0) {
      ...
      doc = (0,_chunk_ZIRB5QZD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .load */ .H)(yamlData, { schema: _chunk_ZIRB5QZD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .JSON_SCHEMA */ .r });
    }
    ...
    if (vertex === void 0) {
      if (textObj === void 0 && type === void 0 && style !== void 0 && style !== null) {
        _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_9__/* .log */ .R.warn(
    ...
    if (doc !== void 0) {
      if (doc.shape) {
        ...
        } else if (!(0,_chunk_ZGVPDNZ5_mjs__WEBPACK_IMPORTED_MODULE_6__/* .isValidShape */ .aP)(doc.shape)) {
  ...
  addSingleLink(_start, _end, type, id) {
    ...
    _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_9__/* .log */ .R.info("abc78 Got edge...", edge);
    ...
    if (id && !this.edges.some((e) => e.id === id)) {
      ...
      if (existingLinks.length === 0) {
        edge.id = (0,_chunk_ICXQ74PX_mjs__WEBPACK_IMPORTED_MODULE_7__/* .getEdgeId */ .rY)(edge.start, edge.end, { counter: 0, prefix: "L" });
      } else {
        edge.id = (0,_chunk_ICXQ74PX_mjs__WEBPACK_IMPORTED_MODULE_7__/* .getEdgeId */ .rY)(edge.start, edge.end, {
    ...
    if (this.edges.length < (this.config.maxEdges ?? 500)) {
      _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_9__/* .log */ .R.info("Pushing edge...");
...
You have to call mermaid.initialize.`
  ...
  addLink(_start, _end, linkData) {
    ...
    _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_9__/* .log */ .R.info("addLink", _start, _end, id);
  ...
  setClickFun(id, functionName, functionArgs) {
    if ((0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().securityLevel !== "loose") {
      return;
    }
      ...
      this.funs.push(() => {
        ...
        if (elem !== null) {
          elem.addEventListener(
            "click",
            () => {
              _chunk_ICXQ74PX_mjs__WEBPACK_IMPORTED_MODULE_7__/* .utils_default */ ._K.runFunc(functionName, ...argList);
            },
            false
          );
        }
  ...
  setLink(ids, linkStr, target) {
    ids.split(",").forEach((id) => {
      const vertex = this.vertices.get(id);
      if (vertex !== void 0) {
        vertex.link = _chunk_ICXQ74PX_mjs__WEBPACK_IMPORTED_MODULE_7__/* .utils_default */ ._K.formatUrl(linkStr, this.config);
  ...
  setupToolTips(element) {
    const tooltipElem = (0,_chunk_32BRIVSS_mjs__WEBPACK_IMPORTED_MODULE_5__/* .createTooltip */ .Ck)();
    ...
    nodes.on("mouseover", (e) => {
      ...
      tooltipElem.html(dompurify__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .A.sanitize(title));
  ...
  clear(ver = "gen-2") {
    ...
    this.version = ver;
    this.config = (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)();
    (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_8__/* .clear */ .IU)();
  }
  setGen(ver) {
  ...
  addSubGraph(_id, list, _title) {
    ...
    const uniq = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)((a) => {
    ...
    const flowchartConfig = (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().flowchart ?? {};
    const dir = rawDir ?? (flowchartConfig.inheritDir ? this.getDirection() ?? (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().direction ?? void 0 : void 0);
    ...
    _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_9__/* .log */ .R.info("Adding", subGraph.id, subGraph.nodes, subGraph.dir);
  ...
  getData() {
    const config = (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)();
    const nodes = [];
    const edges = [];
    ...
    e.forEach((rawEdge, index) => {
      ...
      const edge = {
        id: (0,_chunk_ICXQ74PX_mjs__WEBPACK_IMPORTED_MODULE_7__/* .getEdgeId */ .rY)(rawEdge.start, rawEdge.end, { counter: index, prefix: "L" }, rawEdge.id),
  ...
  defaultConfig() {
    return _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_8__/* .defaultConfig2 */ .ME.flowchart;
  }
};

// src/diagrams/flowchart/flowRenderer-v3-unified.ts
var getClasses = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(function(text, diagramObj) {
  return diagramObj.db.getClasses();
}, "getClasses");
var draw = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(async function(text, id, _version, diag, positions) {
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_9__/* .log */ .R.info("REF0:");
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_9__/* .log */ .R.info("Drawing state diagram (v2)", id);
  const { securityLevel, flowchart: conf, layout } = (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)();
  diag.db.setDiagramId(id);
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_9__/* .log */ .R.debug("Before getData: ");
  const data4Layout = diag.db.getData();
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_9__/* .log */ .R.debug("Data: ", data4Layout);
  const svg = (0,_chunk_XXDRQBXY_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getDiagramElement */ .A)(id, securityLevel);
  const direction = diag.db.getDirection();
  data4Layout.type = diag.type;
  data4Layout.layoutAlgorithm = (0,_chunk_FWX5IMBZ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getRegisteredLayoutAlgorithm */ .q7)(layout);
  ...
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_9__/* .log */ .R.debug("REF1:", data4Layout);
  await (0,_chunk_FWX5IMBZ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .render */ .XX)(data4Layout, svg, positions);
  const padding = data4Layout.config.flowchart?.diagramPadding ?? 8;
  _chunk_ICXQ74PX_mjs__WEBPACK_IMPORTED_MODULE_7__/* .utils_default */ ._K.insertTitle(
    svg,
    "flowchartTitleText",
    conf?.titleTopMargin || 0,
    diag.db.getDiagramTitle()
  );
  (0,_chunk_VR4S4FIN_mjs__WEBPACK_IMPORTED_MODULE_2__/* .setupViewPortForSVG */ .P)(svg, padding, "flowchart", conf?.useMaxWidth || false);
}, "draw");
...
var parser = (function() {
  var o = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(function(k, v, o2, l) {
  ...
  var parser2 = {
    trace: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(function trace() {
    }, "trace"),
    yy: {},
    ...
    performAction: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
      var $0 = $$.length - 1;
      switch (yystate) {
        case 2:
          this.$ = [];
    ...
    defaultActions: {},
    parseError: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(function parseError(str, hash) {
      if (hash.recoverable) {
        this.trace(str);
      } else {
    ...
    parse: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(function parse(input) {
      ...
      (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(popStack, "popStack");
      function lex() {
        var token;
      ...
      (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(lex, "lex");
  ...
  var lexer = /* @__PURE__ */ (function() {
    var lexer2 = {
      ...
      setInput: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(function(input, yy) {
        this.yy = yy || this.yy || {};
        this._input = input;
      ...
      input: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(function() {
      ...
      unput: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(function(ch) {
        var len = ch.length;
        var lines = ch.split(/(?:\r\n?|\n)/g);
      ...
      more: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(function() {
        this._more = true;
        return this;
      }, "more"),
      // When called from action, signals the lexer that this rule fails to match the input, so the next matching rule (regex) should be tested instead.
      reject: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(function() {
      ...
      less: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(function(n) {
        this.unput(this.match.slice(n));
      }, "less"),
      // displays already matched input, i.e. for error messages
      pastInput: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(function() {
        var past = this.matched.substr(0, this.matched.length - this.match.length);
        return (past.length > 20 ? "..." : "") + past.substr(-20).replace(/\n/g, "");
      }, "pastInput"),
      // displays upcoming input, i.e. for error messages
      upcomingInput: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(function() {
        var next = this.match;
        if (next.length < 20) {
      ...
      showPosition: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(function() {
        var pre = this.pastInput();
        var c = new Array(pre.length + 1).join("-");
        return pre + this.upcomingInput() + "\n" + c + "^";
      }, "showPosition"),
      // test the lexed token: return FALSE when not a match, otherwise return token
      test_match: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(function(match, indexed_rule) {
      ...
      next: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(function() {
        if (this.done) {
          return this.EOF;
        }
        if (!this._input) {
      ...
      lex: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(function lex() {
        var r = this.next();
        if (r) {
          return r;
        } else {
      ...
      begin: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(function begin(condition) {
        this.conditionStack.push(condition);
      }, "begin"),
      // pop the previously active lexer condition state off the condition stack
      popState: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(function popState() {
      ...
      _currentRules: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(function _currentRules() {
      ...
      topState: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(function topState(n) {
      ...
      pushState: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(function pushState(condition) {
        this.begin(condition);
      }, "pushState"),
      // return the number of states currently on the stack
      stateStackSize: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(function stateStackSize() {
        return this.conditionStack.length;
      }, "stateStackSize"),
      options: {},
      performAction: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(function anonymous(yy, yy_, $avoiding_name_collisions, YY_START) {
  ...
  (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(Parser, "Parser");
...
var fade = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)((color, opacity) => {
...
var getStyles = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)((options) => `.label {
  ...
  ${(0,_chunk_5VM5RSS4_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getIconStyles */ .o)()}
`, "getStyles");
var styles_default = getStyles;

// src/diagrams/flowchart/flowDiagram.ts
var createFlowDiagram = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(({
  defaultLayout,
  ...
  styles,
  init: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)((cnf) => {
    if (!cnf.flowchart) {
      cnf.flowchart = {};
    }
    const layout = (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getUserDefinedConfig */ .TM)().layout ?? defaultLayout ?? cnf.layout;
    if (layout) {
      (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_8__/* .setConfig2 */ .XV)({ layout });
    }
    cnf.flowchart.arrowMarkerAbsolute = cnf.arrowMarkerAbsolute;
    (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_8__/* .setConfig2 */ .XV)({ flowchart: { arrowMarkerAbsolute: cnf.arrowMarkerAbsolute } });
  }, "init")
}), "createFlowDiagram");
...
var setupViewPortForSVG = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K)((svg, padding, cssDiagram, useMaxWidth) => {
  ...
  (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_0__/* .configureSvgSize */ .a$)(svg, height, width, useMaxWidth);
