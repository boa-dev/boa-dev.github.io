"use strict";
(globalThis["webpackChunkboajs_dev"] = globalThis["webpackChunkboajs_dev"] || []).push([[1679],{
...
/* harmony import */ var _chunk_QZHKN3VN_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2938);
...
var DEFAULT_GITGRAPH_CONFIG = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__/* .defaultConfig_default */ .UI.gitGraph;
var getConfig2 = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(() => {
  const config = (0,_chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_2__/* .cleanAndMerge */ .$t)({
    ...
    ...(0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig */ .zj)().gitGraph
  });
  return config;
}, "getConfig");
...
function getID() {
  return (0,_chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_2__/* .random */ .yT)({ length: 7 });
}
...
var commit = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function(commitDB) {
  ...
  const config = getConfig2();
  id = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(id, config);
  msg = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(msg, config);
  tags = tags?.map((tag) => _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(tag, config));
  const newCommit = {
...
var branch = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function(branchDB) {
  ...
  name = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(name, getConfig2());
...
var merge = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((mergeDB) => {
  ...
  const config = getConfig2();
  otherBranch = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(otherBranch, config);
  if (customId) {
    customId = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(customId, config);
  }
...
var cherryPick = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function(cherryPickDB) {
  ...
  const config = getConfig2();
  sourceId = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(sourceId, config);
  targetId = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(targetId, config);
  tags = tags?.map((tag) => _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(tag, config));
  parentCommitId = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(parentCommitId, config);
...
var checkout = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function(branch2) {
  branch2 = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(branch2, getConfig2());
...
var drawCommitLabel = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((gLabels, commit2, commitPosition, pos, gitGraphConfig) => {
...
var drawCommits = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((svg, commits, modifyGraph, gitGraphConfig) => {
...
var drawBranches = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((svg, branches, gitGraphConfig) => {
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function(txt, id, ver, diagObj) {
  ...
  if (!db2.getConfig) {
    _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.error("getConfig method is not available on db");
    return;
  }
  ...
  _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default */ ._K.insertTitle(
    diagram2,
    "gitTitleText",
    gitGraphConfig.titleTopMargin ?? 0,
    db2.getDiagramTitle()
  );
  (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__/* .setupGraphViewbox2 */ .mj)(void 0, diagram2, gitGraphConfig.diagramPadding, gitGraphConfig.useMaxWidth);
}, "draw");
