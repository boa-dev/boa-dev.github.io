"use strict";
(globalThis["webpackChunkboajs_dev"] = globalThis["webpackChunkboajs_dev"] || []).push([[5359],{
...
var TextDimensionCalculatorWithFont = class {
  ...
  getMaxDimension(texts, fontSize) {
    ...
    for (const t of texts) {
      const bbox = (0,_chunk_PU5JKC2W_mjs__WEBPACK_IMPORTED_MODULE_1__/* .computeDimensionOfText */ .W6)(elem, 1, t);
...
function getChartDefaultThemeConfig() {
  ...
  const config = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig */ .zj)();
  return (0,_chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_2__/* .cleanAndMerge */ .$t)(defaultThemeVariables.xyChart, config.themeVariables.xyChart);
}
(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(getChartDefaultThemeConfig, "getChartDefaultThemeConfig");
function getChartDefaultConfig() {
  const config = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig */ .zj)();
  return (0,_chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_2__/* .cleanAndMerge */ .$t)(
    _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__/* .defaultConfig_default */ .UI.xyChart,
    config.xyChart
  );
}
...
function textSanitizer(text) {
  const config = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig */ .zj)();
  return (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__/* .sanitizeText */ .jZ)(text.trim(), config);
}
...
function getDrawableElem() {
  ...
  xyChartData.title = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getDiagramTitle */ .ab)();
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((txt, id, _version, diagObj) => {
  ...
  (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_3__/* .configureSvgSize */ .a$)(svg, chartConfig.height, chartConfig.width, true);
