"use strict";
(self["webpackChunkboajs_dev"] = self["webpackChunkboajs_dev"] || []).push([[8731],{
...
/* harmony import */ var _utils_errors_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1564);
/* harmony import */ var _languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2151);
/* harmony import */ var _syntax_tree_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2479);
/* harmony import */ var _ast_utils_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9683);
/* harmony import */ var _cst_utils_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6373);
/* harmony import */ var _regexp_utils_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(2806);
/******************************************************************************
...
function getEntryRule(grammar) {
    return grammar.rules.find(e => _languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isParserRule */ .s7(e) && e.entry);
}
/**
 * Returns all hidden terminal rules of the given grammar, if any.
 */
function getHiddenRules(grammar) {
    return grammar.rules.filter((e) => _languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isTerminalRule */ .rE(e) && e.hidden);
}
/**
...
function getAllReachableRules(grammar, allTerminals) {
    ...
    for (const rule of grammar.rules) {
        if (ruleNames.has(rule.name) || (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isTerminalRule */ .rE(rule) && rule.hidden)) {
            rules.add(rule);
        }
    }
    return rules;
...
function ruleDfs(rule, visitedSet, allTerminals) {
    ...
    (0,_ast_utils_js__WEBPACK_IMPORTED_MODULE_3__/* .streamAllContents */ .Uo)(rule).forEach(node => {
        if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isRuleCall */ .$g(node) || (allTerminals && _languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isTerminalRuleCall */ .lF(node))) {
...
function isCommentTerminal(terminalRule) {
    return terminalRule.hidden && !(0,_regexp_utils_js__WEBPACK_IMPORTED_MODULE_5__/* .isWhitespace */ .Yv)(terminalRegex(terminalRule));
}
/**
...
function findNodesForPropertyInternal(node, property, element, first) {
    if (!first) {
        const nodeFeature = (0,_ast_utils_js__WEBPACK_IMPORTED_MODULE_3__/* .getContainerOfType */ .XG)(node.grammarSource, _languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isAssignment */ .wh);
        if (nodeFeature && nodeFeature.feature === property) {
            return [node];
        }
    }
    if ((0,_syntax_tree_js__WEBPACK_IMPORTED_MODULE_2__/* .isCompositeCstNode */ .mD)(node) && node.astNode === element) {
...
function findNodesForKeywordInternal(node, keyword, element) {
    ...
    if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isKeyword */ .wb(node.grammarSource) && node.grammarSource.value === keyword) {
        return [node];
    }
    ...
    do {
        ...
        if (!result.done) {
            ...
            if (childNode.astNode === element) {
                if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isKeyword */ .wb(childNode.grammarSource) && childNode.grammarSource.value === keyword) {
...
function findAssignment(cstNode) {
    ...
    while (astNode === ((_a = cstNode.container) === null || _a === void 0 ? void 0 : _a.astNode)) {
        const assignment = (0,_ast_utils_js__WEBPACK_IMPORTED_MODULE_3__/* .getContainerOfType */ .XG)(cstNode.grammarSource, _languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isAssignment */ .wh);
        if (assignment) {
            return assignment;
        }
...
function findNameAssignment(type) {
    let startNode = type;
    if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isInferredType */ .SP(startNode)) {
        // for inferred types, the location to start searching for the name-assignment is different
        if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isAction */ .ve(startNode.$container)) {
            // a type which is explicitly inferred by an action: investigate the sibbling of the Action node, i.e. start searching at the Action's parent
            startNode = startNode.$container.$container;
        }
        else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isParserRule */ .s7(startNode.$container)) {
            // investigate the parser rule with the explicitly inferred type
            startNode = startNode.$container;
        }
        else {
            (0,_utils_errors_js__WEBPACK_IMPORTED_MODULE_0__/* .assertUnreachable */ .d)(startNode.$container);
        }
    }
...
function findNameAssignmentInternal(type, startNode, cache) {
    ...
    function go(node, refType) {
        ...
        const parentAssignment = (0,_ast_utils_js__WEBPACK_IMPORTED_MODULE_3__/* .getContainerOfType */ .XG)(node, _languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isAssignment */ .wh);
    ...
    for (const node of (0,_ast_utils_js__WEBPACK_IMPORTED_MODULE_3__/* .streamAllContents */ .Uo)(startNode)) {
        if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isAssignment */ .wh(node) && node.feature.toLowerCase() === 'name') {
            cache.set(type, node);
            return node;
        }
        else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isRuleCall */ .$g(node) && _languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isParserRule */ .s7(node.rule.ref)) {
            return go(node, node.rule.ref);
        }
        else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isSimpleType */ .D8(node) && ((_a = node.typeRef) === null || _a === void 0 ? void 0 : _a.ref)) {
...
function isDataTypeRuleInternal(rule, visited) {
    ...
    for (const node of (0,_ast_utils_js__WEBPACK_IMPORTED_MODULE_3__/* .streamAllContents */ .Uo)(rule)) {
        if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isRuleCall */ .$g(node)) {
            if (!node.rule.ref) {
                // RuleCall to unresolved rule. Don't assume `rule` is a DataType rule.
                return false;
            }
            if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isParserRule */ .s7(node.rule.ref) && !isDataTypeRuleInternal(node.rule.ref, visited)) {
                return false;
            }
        }
        else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isAssignment */ .wh(node)) {
            return false;
        }
        else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isAction */ .ve(node)) {
            return false;
        }
    }
...
function getExplicitRuleType(rule) {
    if (rule.inferredType) {
        ...
        if (refType) {
            ...
            if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isParserRule */ .s7(refType)) {
                return refType.name;
            }
            else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isInterface */ .S2(refType) || _languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isType */ .Xj(refType)) {
                return refType.name;
            }
        }
    }
...
function getTypeName(type) {
    var _a;
    if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isParserRule */ .s7(type)) {
        return isDataTypeRule(type) ? type.name : (_a = getExplicitRuleType(type)) !== null && _a !== void 0 ? _a : type.name;
    }
    else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isInterface */ .S2(type) || _languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isType */ .Xj(type) || _languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isReturnType */ .fG(type)) {
        return type.name;
    }
    else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isAction */ .ve(type)) {
        const actionType = getActionType(type);
        if (actionType) {
            return actionType;
        }
    }
    else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isInferredType */ .SP(type)) {
        return type.name;
    }
...
function getRuleType(rule) {
    var _a, _b, _c;
    if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isTerminalRule */ .rE(rule)) {
        return (_b = (_a = rule.type) === null || _a === void 0 ? void 0 : _a.name) !== null && _b !== void 0 ? _b : 'string';
    }
    else {
...
function abstractElementToRegex(element, flags) {
    if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isTerminalAlternatives */ .Fy(element)) {
        return terminalAlternativesToRegex(element);
    }
    else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isTerminalGroup */ .O4(element)) {
        return terminalGroupToRegex(element);
    }
    else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isCharacterRange */ .Bg(element)) {
        return characterRangeToRegex(element);
    }
    else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isTerminalRuleCall */ .lF(element)) {
    ...
    else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isNegatedToken */ .GL(element)) {
        return negateTokenToRegex(element);
    }
    else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isUntilToken */ .Mz(element)) {
        return untilTokenToRegex(element);
    }
    else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isRegexToken */ .vd(element)) {
    ...
    else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isWildcard */ .z2(element)) {
...
function keywordToRegex(keyword) {
    return (0,_regexp_utils_js__WEBPACK_IMPORTED_MODULE_5__/* .escapeRegExp */ .Nt)(keyword.value);
}
...
/* harmony import */ var _chunk_4KMFLZZN_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8198);
/* harmony import */ var langium__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8913);
/* harmony import */ var langium__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9364);
/* harmony import */ var langium__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4298);
...
function createInfoServices(context = langium__WEBPACK_IMPORTED_MODULE_3__/* .EmptyFileSystem */ .D) {
...
/* harmony import */ var _languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2151);
/* harmony import */ var _utils_ast_utils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9683);
/* harmony import */ var _utils_grammar_utils_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(418);
/* harmony import */ var _utils_regexp_utils_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(2806);
/* harmony import */ var _utils_stream_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(1719);
/******************************************************************************
 * Copyright 2021 TypeFox GmbH
 * This program and the accompanying materials are made available under the
 * terms of the MIT License, which is available in the project root.
...
class DefaultTokenBuilder {
    ...
    buildTokens(grammar, options) {
        const reachableRules = (0,_utils_stream_js__WEBPACK_IMPORTED_MODULE_5__/* .stream */ .Td)((0,_utils_grammar_utils_js__WEBPACK_IMPORTED_MODULE_3__/* .getAllReachableRules */ .YV)(grammar, false));
        const terminalTokens = this.buildTerminalTokens(reachableRules);
        const tokens = this.buildKeywordTokens(reachableRules, terminalTokens, options);
        terminalTokens.forEach(terminalToken => {
            const pattern = terminalToken.PATTERN;
            if (typeof pattern === 'object' && pattern && 'test' in pattern && (0,_utils_regexp_utils_js__WEBPACK_IMPORTED_MODULE_4__/* .isWhitespace */ .Yv)(pattern)) {
    ...
    buildTerminalTokens(rules) {
        return rules.filter(_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isTerminalRule */ .rE).filter(e => !e.fragment)
            .map(terminal => this.buildTerminalToken(terminal)).toArray();
    }
    buildTerminalToken(terminal) {
        const regex = (0,_utils_grammar_utils_js__WEBPACK_IMPORTED_MODULE_3__/* .terminalRegex */ .S)(terminal);
        ...
        if (terminal.hidden) {
            ...
            tokenType.GROUP = (0,_utils_regexp_utils_js__WEBPACK_IMPORTED_MODULE_4__/* .isWhitespace */ .Yv)(regex) ? chevrotain__WEBPACK_IMPORTED_MODULE_0__/* .Lexer */ .JG.SKIPPED : 'hidden';
        }
        return tokenType;
    }
    ...
    buildKeywordTokens(rules, terminalTokens, options) {
        return rules
            ...
            .filter(_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isParserRule */ .s7)
            .flatMap(rule => (0,_utils_ast_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .streamAllContents */ .Uo)(rule).filter(_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_1__/* .isKeyword */ .wb))
    ...
    buildKeywordPattern(keyword, caseInsensitive) {
        return caseInsensitive ?
            new RegExp((0,_utils_regexp_utils_js__WEBPACK_IMPORTED_MODULE_4__/* .getCaseInsensitivePattern */ .Ao)(keyword.value)) :
            keyword.value;
    }
    findLongerAlt(keyword, terminalTokens) {
        return terminalTokens.reduce((longerAlts, token) => {
            const pattern = token === null || token === void 0 ? void 0 : token.PATTERN;
            if ((pattern === null || pattern === void 0 ? void 0 : pattern.source) && (0,_utils_regexp_utils_js__WEBPACK_IMPORTED_MODULE_4__/* .partialMatches */ .PC)('^' + pattern.source + '$', keyword.value)) {
...
function createTreemapServices(context = langium__WEBPACK_IMPORTED_MODULE_3__/* .EmptyFileSystem */ .D) {
  const shared = (0,langium__WEBPACK_IMPORTED_MODULE_2__/* .inject */ .WQ)(
    (0,langium__WEBPACK_IMPORTED_MODULE_1__/* .createDefaultSharedCoreModule */ .u)(context),
    _chunk_4KMFLZZN_mjs__WEBPACK_IMPORTED_MODULE_0__/* .MermaidGeneratedSharedModule */ .sr
  );
...
function createGitGraphServices(context = langium__WEBPACK_IMPORTED_MODULE_3__/* .EmptyFileSystem */ .D) {
  const shared = (0,langium__WEBPACK_IMPORTED_MODULE_2__/* .inject */ .WQ)(
    (0,langium__WEBPACK_IMPORTED_MODULE_1__/* .createDefaultSharedCoreModule */ .u)(context),
    _chunk_4KMFLZZN_mjs__WEBPACK_IMPORTED_MODULE_0__/* .MermaidGeneratedSharedModule */ .sr
  );
...
/* harmony import */ var _baseIteratee_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3958);
...
function streamCst(node) {
    return new _stream_js__WEBPACK_IMPORTED_MODULE_1__/* .TreeStreamImpl */ .Vj(node, element => {
        if ((0,_syntax_tree_js__WEBPACK_IMPORTED_MODULE_0__/* .isCompositeCstNode */ .mD)(element)) {
...
function findCommentNode(cstNode, commentNames) {
    if (cstNode) {
        ...
        if ((0,_syntax_tree_js__WEBPACK_IMPORTED_MODULE_0__/* .isRootCstNode */ .br)(cstNode)) {
...
function isCommentNode(cstNode, commentNames) {
    return (0,_syntax_tree_js__WEBPACK_IMPORTED_MODULE_0__/* .isLeafCstNode */ .FC)(cstNode) && commentNames.includes(cstNode.tokenType.name);
}
/**
...
/* harmony import */ var _baseLt_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6224);
/* harmony import */ var _identity_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9008);
...
function min(array) {
  return (array && array.length)
    ? (0,_baseExtremum_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(array, _identity_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A, _baseLt_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)
    : undefined;
}
...
/* harmony import */ var _chunks_mermaid_parser_core_chunk_BN7GFLIU_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4087);
/* harmony import */ var _chunks_mermaid_parser_core_chunk_T44TD3VJ_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1366);
/* harmony import */ var _chunks_mermaid_parser_core_chunk_KMC2YHZD_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9811);
/* harmony import */ var _chunks_mermaid_parser_core_chunk_WFWHJNB7_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9786);
/* harmony import */ var _chunks_mermaid_parser_core_chunk_JEIROHC2_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3009);
/* harmony import */ var _chunks_mermaid_parser_core_chunk_WFRQ32O7_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(2852);
/* harmony import */ var _chunks_mermaid_parser_core_chunk_XRWGC2XP_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(3758);
/* harmony import */ var _chunks_mermaid_parser_core_chunk_4KMFLZZN_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(8198);
...
var initializers = {
  info: /* @__PURE__ */ (0,_chunks_mermaid_parser_core_chunk_4KMFLZZN_mjs__WEBPACK_IMPORTED_MODULE_7__/* .__name */ .K2)(async () => {
    const { createInfoServices: createInfoServices2 } = await __webpack_require__.e(/* import() */ 2068).then(__webpack_require__.bind(__webpack_require__, 2068));
    const parser = createInfoServices2().Info.parser.LangiumParser;
    parsers.info = parser;
  }, "info"),
  packet: /* @__PURE__ */ (0,_chunks_mermaid_parser_core_chunk_4KMFLZZN_mjs__WEBPACK_IMPORTED_MODULE_7__/* .__name */ .K2)(async () => {
    const { createPacketServices: createPacketServices2 } = await __webpack_require__.e(/* import() */ 8716).then(__webpack_require__.bind(__webpack_require__, 8716));
  ...
  pie: /* @__PURE__ */ (0,_chunks_mermaid_parser_core_chunk_4KMFLZZN_mjs__WEBPACK_IMPORTED_MODULE_7__/* .__name */ .K2)(async () => {
    const { createPieServices: createPieServices2 } = await __webpack_require__.e(/* import() */ 8188).then(__webpack_require__.bind(__webpack_require__, 8188));
  ...
  architecture: /* @__PURE__ */ (0,_chunks_mermaid_parser_core_chunk_4KMFLZZN_mjs__WEBPACK_IMPORTED_MODULE_7__/* .__name */ .K2)(async () => {
    const { createArchitectureServices: createArchitectureServices2 } = await __webpack_require__.e(/* import() */ 2498).then(__webpack_require__.bind(__webpack_require__, 2498));
  ...
  gitGraph: /* @__PURE__ */ (0,_chunks_mermaid_parser_core_chunk_4KMFLZZN_mjs__WEBPACK_IMPORTED_MODULE_7__/* .__name */ .K2)(async () => {
    const { createGitGraphServices: createGitGraphServices2 } = await __webpack_require__.e(/* import() */ 5392).then(__webpack_require__.bind(__webpack_require__, 5392));
  ...
  radar: /* @__PURE__ */ (0,_chunks_mermaid_parser_core_chunk_4KMFLZZN_mjs__WEBPACK_IMPORTED_MODULE_7__/* .__name */ .K2)(async () => {
    const { createRadarServices: createRadarServices2 } = await __webpack_require__.e(/* import() */ 3956).then(__webpack_require__.bind(__webpack_require__, 3956));
  ...
  treemap: /* @__PURE__ */ (0,_chunks_mermaid_parser_core_chunk_4KMFLZZN_mjs__WEBPACK_IMPORTED_MODULE_7__/* .__name */ .K2)(async () => {
    const { createTreemapServices: createTreemapServices2 } = await __webpack_require__.e(/* import() */ 4504).then(__webpack_require__.bind(__webpack_require__, 4504));
...
var _castPath = __webpack_require__(200);
...
/* harmony import */ var _isObjectLike_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3098);
...
function isString(value) {
  return typeof value == 'string' ||
    (!(0,_isArray_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(value) && (0,_isObjectLike_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)(value) && (0,_baseGetTag_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(value) == stringTag);
}
...
function createPieServices(context = langium__WEBPACK_IMPORTED_MODULE_3__/* .EmptyFileSystem */ .D) {
  const shared = (0,langium__WEBPACK_IMPORTED_MODULE_2__/* .inject */ .WQ)(
    (0,langium__WEBPACK_IMPORTED_MODULE_1__/* .createDefaultSharedCoreModule */ .u)(context),
    _chunk_4KMFLZZN_mjs__WEBPACK_IMPORTED_MODULE_0__/* .MermaidGeneratedSharedModule */ .sr
  );
...
function createPacketServices(context = langium__WEBPACK_IMPORTED_MODULE_3__/* .EmptyFileSystem */ .D) {
  const shared = (0,langium__WEBPACK_IMPORTED_MODULE_2__/* .inject */ .WQ)(
    (0,langium__WEBPACK_IMPORTED_MODULE_1__/* .createDefaultSharedCoreModule */ .u)(context),
    _chunk_4KMFLZZN_mjs__WEBPACK_IMPORTED_MODULE_0__/* .MermaidGeneratedSharedModule */ .sr
  );
