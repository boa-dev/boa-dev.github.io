"use strict";
(globalThis["webpackChunkboajs_dev"] = globalThis["webpackChunkboajs_dev"] || []).push([[6317],{
...
var TreeMapDB = class {
  ...
  static {
    (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__/* .__name */ .K)(this, "TreeMapDB");
  }
  getNodes() {
    return this.nodes;
  }
  getConfig() {
    const defaultConfig = _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_5__/* .defaultConfig_default */ .UI;
    const userConfig = (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig */ .zj)();
  ...
  addClass(id, _style) {
    ...
    if (styles) {
      styles.forEach((s) => {
        if ((0,_chunk_C7G6YPKG_mjs__WEBPACK_IMPORTED_MODULE_3__/* .isLabelStyle */ .KX)(s)) {
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__/* .__name */ .K)(buildHierarchy, "buildHierarchy");

// src/diagrams/treemap/parser.ts
var populate = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__/* .__name */ .K)((ast, db) => {
  ...
  const addNodesRecursively = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__/* .__name */ .K)((nodes, level) => {
...
var getItemName = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__/* .__name */ .K)((item) => {
  return item.name ? String(item.name) : "";
}, "getItemName");
var parser = {
  // @ts-expect-error - TreeMapDB is not assignable to DiagramDB
  parser: { yy: void 0 },
  parse: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__/* .__name */ .K)(async (text) => {
    try {
      const parseFunc = _mermaid_js_parser__WEBPACK_IMPORTED_MODULE_8__/* .parse */ .qg;
      const ast = await parseFunc("treemap", text);
      _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .R.debug("Treemap AST:", ast);
      ...
      _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .R.error("Error parsing treemap:", error);
      throw error;
    }
  }, "parse")
};
...
var draw = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__/* .__name */ .K)((_text, id, _version, diagram2) => {
  const treemapDb = diagram2.db;
  const config = treemapDb.getConfig();
  const treemapInnerPadding = config.padding ?? DEFAULT_INNER_PADDING;
  const title = treemapDb.getDiagramTitle();
  const root = treemapDb.getRoot();
  const { themeVariables } = (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig */ .zj)();
  if (!root) {
    return;
  }
  ...
  (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_5__/* .configureSvgSize */ .a$)(svg, svgHeight, svgWidth, config.useMaxWidth);
  let valueFormat;
  try {
    const formatStr = config.valueFormat || ",";
    if (formatStr === "$0,0") {
      valueFormat = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__/* .__name */ .K)((value) => "$" + (0,d3__WEBPACK_IMPORTED_MODULE_9__/* .format */ .GPZ)(",")(value), "valueFormat");
    } else if (formatStr.startsWith("$") && formatStr.includes(",")) {
      const precision = /\.\d+/.exec(formatStr);
      const precisionStr = precision ? precision[0] : "";
      valueFormat = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__/* .__name */ .K)((value) => "$" + (0,d3__WEBPACK_IMPORTED_MODULE_9__/* .format */ .GPZ)("," + precisionStr)(value), "valueFormat");
    } else if (formatStr.startsWith("$")) {
      const restOfFormat = formatStr.substring(1);
      valueFormat = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__/* .__name */ .K)((value) => "$" + (0,d3__WEBPACK_IMPORTED_MODULE_9__/* .format */ .GPZ)(restOfFormat || "")(value), "valueFormat");
    } else {
      valueFormat = (0,d3__WEBPACK_IMPORTED_MODULE_9__/* .format */ .GPZ)(formatStr);
    }
  } catch (error) {
    _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .R.error("Error creating format function:", error);
    valueFormat = (0,d3__WEBPACK_IMPORTED_MODULE_9__/* .format */ .GPZ)(",");
  }
  const colorScale = (0,d3__WEBPACK_IMPORTED_MODULE_9__/* .scaleOrdinal */ .UMr)().range([
    "transparent",
  ...
  const colorScalePeer = (0,d3__WEBPACK_IMPORTED_MODULE_9__/* .scaleOrdinal */ .UMr)().range([
    "transparent",
  ...
  const colorScaleLabel = (0,d3__WEBPACK_IMPORTED_MODULE_9__/* .scaleOrdinal */ .UMr)().range([
  ...
  const hierarchyRoot = (0,d3__WEBPACK_IMPORTED_MODULE_9__/* .hierarchy */ .Sk5)(root).sum((d) => d.value ?? 0).sort((a, b) => (b.value ?? 0) - (a.value ?? 0));
  const treemapLayout = (0,d3__WEBPACK_IMPORTED_MODULE_9__/* .treemap */ .hkb)().size([width, height]).paddingTop(
  ...
  sections.append("rect").attr("width", (d) => d.x1 - d.x0).attr("height", (d) => d.y1 - d.y0).attr("class", (_d, i) => {
    ...
    const styles = (0,_chunk_C7G6YPKG_mjs__WEBPACK_IMPORTED_MODULE_3__/* .styles2String */ .GX)({ cssCompiledStyles: d.data.cssCompiledStyles });
  ...
  sections.append("text").attr("class", "treemapSectionLabel").attr("x", 6).attr("y", SECTION_HEADER_HEIGHT / 2).attr("dominant-baseline", "middle").text((d) => d.depth === 0 ? "" : d.data.name).attr("font-weight", "bold").attr("clip-path", (_d, i) => `url(#clip-section-${id}-${i})`).attr("style", (d) => {
    ...
    const self = (0,d3__WEBPACK_IMPORTED_MODULE_9__/* .select */ .Ltv)(this);
  ...
  if (config.showValues !== false) {
    ...
    leafValues.each(function(d) {
      const valueTextElement = (0,d3__WEBPACK_IMPORTED_MODULE_9__/* .select */ .Ltv)(this);
      const parentCellNode = this.parentNode;
      if (!parentCellNode) {
        valueTextElement.style("display", "none");
        return;
      }
      const labelElement = (0,d3__WEBPACK_IMPORTED_MODULE_9__/* .select */ .Ltv)(parentCellNode).select(".treemapLabel");
  ...
  (0,_chunk_VR4S4FIN_mjs__WEBPACK_IMPORTED_MODULE_2__/* .setupViewPortForSVG */ .P)(svg, diagramPadding, "flowchart", config?.useMaxWidth || false);
}, "draw");
var getClasses = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__/* .__name */ .K)(function(_text, diagramObj) {
...
var getStyles = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__/* .__name */ .K)(({
  treemap: treemap2
} = {}) => {
  const defaultThemeVariables = (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getThemeVariables */ .P$)();
  const currentConfig = (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig */ .zj)();
  const themeVariables = (0,_chunk_ICXQ74PX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .cleanAndMerge */ .$t)(defaultThemeVariables, currentConfig.themeVariables);
  const options = (0,_chunk_ICXQ74PX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .cleanAndMerge */ .$t)(defaultTreemapStyleOptions, treemap2);
