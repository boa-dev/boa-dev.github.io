"use strict";
(globalThis["webpackChunkboajs_dev"] = globalThis["webpackChunkboajs_dev"] || []).push([[878],{
...
/* harmony import */ var _chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(796);
/* harmony import */ var _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2391);
/* harmony import */ var _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(797);
/* harmony import */ var roughjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(9893);
...
var IshikawaDB = class {
  ...
  static {
    (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(this, "IshikawaDB");
  }
  clear() {
    this.root = void 0;
    this.stack = [];
    this.baseLevel = void 0;
    (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_2__/* .clear */ .IU)();
  }
  getRoot() {
    return this.root;
  }
  addNode(rawLevel, text) {
    const label = _chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_2__/* .common_default */ .Y2.sanitizeText(text, (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getConfig2 */ .D7)());
    if (!this.root) {
      this.baseLevel = rawLevel;
      this.root = { text: label, children: [] };
      this.stack = [{ level: 0, node: this.root }];
      (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_2__/* .setDiagramTitle */ .ke)(label);
      return;
    }
  ...
  getAccTitle() {
    return (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getAccTitle */ .iN)();
  }
  setAccTitle(title) {
    (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_2__/* .setAccTitle */ .SV)(title);
  }
  getAccDescription() {
    return (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getAccDescription */ .m7)();
  }
  setAccDescription(description) {
    (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_2__/* .setAccDescription */ .EI)(description);
  }
  getDiagramTitle() {
    return (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getDiagramTitle */ .ab)();
  }
  setDiagramTitle(title) {
    (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_2__/* .setDiagramTitle */ .ke)(title);
  }
};
...
var applyPaddedViewBox = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((svgEl, pad, maxW) => {
  const bbox = svgEl.node().getBBox();
  const w = bbox.width + pad * 2;
  const h = bbox.height + pad * 2;
  (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_2__/* .configureSvgSize */ .a$)(svgEl, h, w, maxW);
  svgEl.attr("viewBox", `${bbox.x - pad} ${bbox.y - pad} ${w} ${h}`);
}, "applyPaddedViewBox");
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((_text, id, _version, diagram2) => {
  const db = diagram2.db;
  const root = db.getRoot();
  if (!root) {
    return;
  }
  const drawConfig = (0,_chunk_7R4GIKGN_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getConfig2 */ .D7)();
  const { look, handDrawnSeed, themeVariables } = drawConfig;
  const fontSize = (0,_chunk_GEFDOKGD_mjs__WEBPACK_IMPORTED_MODULE_1__/* .parseFontSize */ .I5)(drawConfig.fontSize)[0] ?? FONT_SIZE_DEFAULT;
  ...
  const roughSvg = isHandDrawn ? roughjs__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A.svg(svg.node()) : void 0;
...
var sideStats = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((nodes) => {
  const countDescendants = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((node) => node.children.reduce((sum, child) => sum + 1 + countDescendants(child), 0), "countDescendants");
  return nodes.reduce(
    (stats, node) => {
...
var drawHead = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((svg, x, y, label, fontSize, roughContext) => {
...
var flattenTree = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((children, direction) => {
  const entries = [];
  const yOrder = [];
  const walk = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((nodes, pid, depth) => {
...
var drawCauseLabel = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((svg, text, x, y, direction, fontSize, roughContext) => {
...
var drawArrowMarker = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((g, x, y, dx, dy, roughContext) => {
...
var drawBranch = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((svg, node, startX, startY, direction, length, fontSize, roughContext) => {
...
var splitLines = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((text) => text.split(/<br\s*\/?>|\n/), "splitLines");
var wrapText = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((text, maxChars) => {
...
var drawMultilineText = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((g, text, x, y, cls, anchor, fontSize) => {
...
var lerp = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((a, b, t) => a + (b - a) * t, "lerp");
var drawLine = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((g, x1, y1, x2, y2, cls, roughContext) => {
  if (roughContext) {
...
var getStyles = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((options) => `
