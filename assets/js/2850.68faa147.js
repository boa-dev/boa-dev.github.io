"use strict";
(globalThis["webpackChunkboajs_dev"] = globalThis["webpackChunkboajs_dev"] || []).push([[2850],{
...
var findOrCreateNode = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)((ID) => {
  ID = chunk_7R4GIKGN/* common_default */.Y2.sanitizeText(ID, (0,chunk_7R4GIKGN/* getConfig2 */.D7)());
...
var sankeyDB_default = {
  nodesMap,
  getConfig: /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)(() => (0,chunk_7R4GIKGN/* getConfig2 */.D7)().sankey, "getConfig"),
  getNodes,
  getLinks,
  getGraph,
  addLink,
...
var draw = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)(function(text, id, _version, diagObj) {
  const { securityLevel, sankey: conf } = (0,chunk_7R4GIKGN/* getConfig2 */.D7)();
  const defaultSankeyConfig = chunk_7R4GIKGN/* defaultConfig2 */.ME.sankey;
  let sandboxElement;
...
${prefix}${Math.round(value * 100) / 100}${suffix}`;
  ...
  (0,chunk_7R4GIKGN/* setupGraphViewbox */.ot)(void 0, svg, 0, useMaxWidth);
}, "draw");
