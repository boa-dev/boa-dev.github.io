...
const metadata = {
  "id": "optimizations/overview",
  "title": "Overview",
  "description": "Currently, we are primarily focused on conformance with the ECMAScript Test262 test suite.",
  "source": "@site/docs/optimizations/overview.md",
  "sourceDirName": "optimizations",
  "slug": "/optimizations/overview",
  "permalink": "/docs/optimizations/overview",
  "draft": false,
  "unlisted": false,
  "editUrl": "https://github.com/boa-dev/boa-dev.github.io/tree/main/docs/docs/optimizations/overview.md",
  "tags": [],
  "version": "current",
  "sidebarPosition": 1,
  "frontMatter": {
