"use strict";
(globalThis["webpackChunkboajs_dev"] = globalThis["webpackChunkboajs_dev"] || []).push([[9785],{
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const SocialPlatformConfigs={twitter:{Icon:Socials_Twitter,label:'Twitter'},github:{Icon:Socials_GitHub,label:'GitHub'},stackoverflow:{Icon:Socials_StackOverflow,label:'Stack Overflow'},linkedin:{Icon:Socials_LinkedIn,label:'LinkedIn'},x:{Icon:Socials_X,label:'X'},bluesky:{Icon:Socials_Bluesky,label:'Bluesky'},instagram:{Icon:Socials_Instagram,label:'Instagram'},threads:{Icon:Socials_Threads,label:'Threads'},mastodon:{Icon:Socials_Mastodon,label:'Mastodon'},youtube:{Icon:Socials_YouTube,label:'YouTube'},twitch:{Icon:Socials_Twitch,label:'Twitch'},email:{Icon:Socials_Email,label:'Email'}};function getSocialPlatformConfig(platformKey){return SocialPlatformConfigs[platformKey]??{Icon:Default,label:platformKey};}function SocialLink({platform,link}){const{Icon,label}=getSocialPlatformConfig(platform);return/*#__PURE__*/(0,jsx_runtime.jsx)(Link/* default */.A,{className:Socials_styles_module.authorSocialLink,href:link,title:label,children:/*#__PURE__*/(0,jsx_runtime.jsx)(Icon,{className:(0,clsx/* default */.A)(Socials_styles_module.authorSocialIcon)})});}function BlogAuthorSocials({author}){const entries=Object.entries(author.socials??{});return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:Socials_styles_module.authorSocials,children:entries.map(([platform,linkUrl])=>{return/*#__PURE__*/(0,jsx_runtime.jsx)(SocialLink,{platform:platform,link:linkUrl},platform);})});}
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function MaybeLink(props){if(props.href){return/*#__PURE__*/(0,jsx_runtime.jsx)(Link/* default */.A,{...props});}return/*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment,{children:props.children});}function AuthorTitle({title}){return/*#__PURE__*/(0,jsx_runtime.jsx)("small",{className:Author_styles_module.authorTitle,title:title,children:title});}function AuthorName({name,as}){if(!as){return/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:Author_styles_module.authorName,translate:"no",children:name});}else{return/*#__PURE__*/(0,jsx_runtime.jsx)(Heading/* default */.A,{as:as,className:Author_styles_module.authorName,translate:"no",children:name});}}function AuthorBlogPostCount({count}){return/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:(0,clsx/* default */.A)(Author_styles_module.authorBlogPostCount),children:count});}// Note: in the future we might want to have multiple "BlogAuthor" components
